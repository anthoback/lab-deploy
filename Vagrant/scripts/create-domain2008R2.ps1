...
if ((gwmi win32_computersystem).partofdomain -eq $false) {
  ...
  dcpromo.exe /unattend /replicaOrNewDomain:domain /newDomain:forest /SafeModeAdminPassword:$SecurePassword /createDNSDelegation:No /DatabasePath:"C:\Windows\NTDS" /InstallDns:yes /DomainLevel:3 /ForestLevel:3 /DomainNetbiosName:"WINDOMAIN" /NewDomainDNSName:"$domain" /LogPath:"C:\Windows\NTDS" /SysvolPath:"C:\Windows\SYSVOL" /RebootOnCompletion:No
